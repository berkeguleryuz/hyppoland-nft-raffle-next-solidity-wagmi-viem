export const HypposNFT_CONTRACT = "0x4A84cF3660D7DFFf869151Fd6DE8F4690c6d8b71";

export const Hyppoland_FREE_NFT_CONTRACT_ADDRESS =
...
export const Hyppoland_FREE_NFT_CONTRACT_ABI = [
  ...
  {
    inputs: [
      { internalType: "address", name: "_authorizedCaller", type: "address" },
    ],
...
export const Hyppoland_NFT_RAFFLE_CONTRACT_ABI = [
  {
    anonymous: false,
    inputs: [],
    name: "AuthorizedCallerRemoved",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_baseEntryFee", type: "uint256" },
      { internalType: "address", name: "_nftContract", type: "address" },
      { internalType: "uint256[]", name: "_nftIds", type: "uint256[]" },
    ],
    name: "setupRaffle",
